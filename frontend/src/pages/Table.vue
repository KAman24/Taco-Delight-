        ...
        <form id="bookTableForm" @submit="handleSubmit" novalidate autocomplete="off">
            ...
            <div class="row">
                <div class="input-box">
                    ...
                    <textarea placeholder="your message, Want to decorate your table...??" name="uMessage"
                        id="uMessage" cols="30" rows="10" v-model="orderObj.note"></textarea>
                </div>
                <div class="input-box">
                    <iframe class="map"
                        src="https://www.google.com/maps/place/Symbiosis+Institute+of+Technology+%7C+SIT+Pune/@18.5413032,73.725665,17z/data=!3m1!4b1!4m6!3m5!1s0x3bc2bc3e3d28683b:0x64a3e9ef22f676a0!8m2!3d18.5413032!4d73.7278537!16s%2Fg%2F1260l_1l_"
                        loading="lazy"></iframe>
                </div>
            </div>
